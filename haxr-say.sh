...
help() {
	...
	printf "\t Arts: "; print_array ","  "${!arts[@]}"; printf "\n\n"
	printf "  -c, --color\tColor to use\n"
	printf "\t Colors: "; print_array ","  "${!colors[@]}"; printf "\n\n"
...
say() {
	...
	for ((i = 0; i < ascii_art_lines_n; i++))
	do
		box_line=""
		if (( i >= textbox_start_line && i < textbox_end_line ))
		then
